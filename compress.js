...
var generateCmd = function (filePath, oped) {
    ...
    var ret = FFMPEG + '-y -i "' + filePath + '"'
        ...
        + ' -c:a libfdk_aac -ar 48000  -b:a 128k -movflags +faststart  "outputH"'
        + ' -map "[tv2]" -map "[ta2]"  -crf 23 -pix_fmt yuv420p -c:v libx264 -r 25 -s 854*480 -benchmark -threads 0 -preset veryslow '
        + ' -c:a libfdk_aac -ar 44100 -b:a 96k -movflags +faststart "outputM"'
        ...
        + ' -c:a libfdk_aac -ar 22050 -b:a 64k -movflags +faststart "outputL"'
        ...
        + '  -c:a libfdk_aac -ar 44100 -b:a 96k -movflags +faststart "outputMo"'
